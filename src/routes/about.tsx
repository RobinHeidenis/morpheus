...
function RouteComponent() {
  return (
    <main className="mx-auto p-4 text-ctp-peach xl:w-1/2">
      <h1 className="text-center text-6xl text-ctp-peach">About</h1>
      <div
        className={
          "mt-5 flex w-full flex-col gap-y-3 rounded-lg border border-ctp-peach p-5"
        }
      >
        <p>
        ...
        <p>
          ...
          <a
            ...
            className={"underline decoration-ctp-green"}
          >
            GitHub
          </a>
        </p>
